...
const contactCards = [
    {
        icon: Mail,
        label: 'Email',
        value: 'aryan.sikarwar@example.com',
        href: 'mailto:aryan.sikarwar@example.com',
        color: '#6366f1',
    ...
    },
    {
        icon: Linkedin,
        label: 'LinkedIn',
        value: '/in/aryansikarwar',
        href: 'https://www.linkedin.com/in/aryansikarwar/',
        color: '#06b6d4',
    ...
    },
    {
        ...
        label: 'GitHub',
        value: '@aryansikarwar',
        href: 'https://github.com/aryansikarwar',
        color: '#8b5cf6',
