...
const Intro = ({ onComplete }) => {
    ...
    useEffect(() => {
        // Total intro duration: 3.3 seconds
        ...
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    ...
                    >
                        {Array.from("ARYAN SIKARWAR").map((char, index) => (
                            <motion.span
                                key={index}
                                variants={{
                                    hidden: {
                    ...
                    >
                        SOFTWARE DEVELOPER — CRAFTING SCALABLE SYSTEMS.
                        <br />
                        BUILDING PRODUCTS: ELEGANT, PERFORMANT, IMPACTFUL.
                    </motion.p>
