...
const PAGES = [
    ...
    { name: 'Contact', path: '/contact', icon: Mail, keywords: ['message', 'email', 'reach', 'touch'], desc: 'Collaborate, or say hello' },
    { name: 'Hire Me', path: '/hire', icon: Briefcase, keywords: ['hire', 'work', 'job', 'freelance', 'recruit', 'available', 'project'], desc: 'Hire me for a role, freelance build, or project' },
