...
// ============================================
// CONTACT CONFIG - UPDATE WITH YOUR DETAILS
// ============================================
const socialLinks = [
    {
        name: 'GitHub',
        url: 'https://github.com/aryansikarwar',
        icon: <Github />,
        color: 'primary'
    },
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/aryansikarwar/',
        icon: <LinkedIn />,
        color: 'secondary'
    },
    {
        name: 'Email',
        url: 'mailto:aryan.sikarwar@example.com',
        icon: <Mail />,
        color: 'accent'
    },
]

const CONTACT_EMAIL = 'aryan.sikarwar@example.com'

const languages = [
    "साथ मिलकर काम करें", // Hindi
    "Trabajemos Juntos", // Spanish
    "Travaillons Ensemble", // French
    "Zusammenarbeiten!", // German
    "一緒に働こう", // Japanese
    "함께 하자", // Korean
    "Работаем вместе", // Russian
    "一起工作吧", // Chinese
    "Lavoriamo Insieme", // Italian
    "Vamos Trabalhar", // Portuguese
    "Let's Build Together" // English (Last one)
]

// ============================================
// Contact submissions go to the backend API (POST /api/contact),
// which stores the message and emails you + an auto-reply to the sender.
// Configure NEXT_PUBLIC_API_URL in .env.local (defaults to localhost:5000).
// ============================================
                                ...
                                <AnimatePresence mode="wait">
                                    <motion.span
                                        ...
                                        style={{
                                            ...
                                            whiteSpace: 'nowrap',
                                            fontSize: [0, 2, 6].includes(currentLangIndex) ? '0.7em' : '1em'
                                        }}
                                    >
