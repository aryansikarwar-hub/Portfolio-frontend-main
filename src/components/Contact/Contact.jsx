...
const socialLinks = [
    {
        name: 'GitHub',
        url: 'https://github.com/aryansikarwar-hub',
        icon: <Github />,
        color: 'primary'
    },
    {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/aryan-singh-sikarwar-42211b377/?skipRedirect=true',
        icon: <LinkedIn />,
        color: 'secondary'
    },
    {
        name: 'Email',
        url: 'mailto:aryansinghsikarwar518@gmail.com',
        icon: <Mail />,
        color: 'accent'
    },
    {
